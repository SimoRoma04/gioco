...
start.addEventListener("click", function() {
  ...
  switch (level.value) {
    ...
    case "Difficile":
      ...
      case "Estremo":
        ...
        gameGrid = document.createElement('div');
        gameGrid.classList.add('game_grid');
        gameGrid.classList.add('game_grid_100');
        break;
        ...
        case "Impossibile":
          ...
          gameGrid = document.createElement('div');
          gameGrid.classList.add('game_grid');
          gameGrid.classList.add('game_grid_50');
          break;
  ...
  for (let i = 1; i <= maxAttempts && lost == false; i++) {
    ...
    tableContentImg.src = "img/questiongif.gif";
    ...
    tableSquare.addEventListener("click", function () {
      ...
      for (let j = 0; j < randomPCArray.length; j++) {
        ...
        if (i == randomPCArray[j]) {
          ...
          newImg.src = "img/bombgif.gif"; //aggiungo attributo src al tag creato  
